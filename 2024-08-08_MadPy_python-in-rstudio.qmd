...
If you want to work with Python interactively, you can call `repl_python()` to initiate a Python REPL embedded in the R console.
...
![](assets/repl_python.png){fig-align="center"}
